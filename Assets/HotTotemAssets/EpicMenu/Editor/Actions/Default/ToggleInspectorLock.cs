...
//DISPLAYNAME:Toggle Inspector Lock
//DO NOT REMOVE THE PREVIOUS COMMENT
namespace HotTotemAssets.EpicMenu
{
    public class ToggleInspectorLock : EpicMenuAction
    {
        ...
        public override void Action(Ray sceneViewToEpicMenuCenterRay)
        {
            ...
            if (findObjectsOfTypeAll[0] != null)
            {
                bool value = (bool)propertyInfo.GetValue(findObjectsOfTypeAll[0], null);
                propertyInfo.SetValue(findObjectsOfTypeAll[0], !value, null);
                ((EditorWindow)findObjectsOfTypeAll[0]).Repaint();
            }
        }
    }
}