...
namespace VIRTUE {
    public class MalbersEditor {
        public static GUIStyle StyleGray { get { return Style (new Color (0.5f, 0.5f, 0.5f, 0.3f)); } }
        ...
        public static GUIStyle StyleBlue { get { return Style (new Color (0, 0.5f, 1f, 0.3f)); } }
        public static GUIStyle StyleRed { get { return Style (new Color (1, 0.3f, 0f, 0.3f)); } }
        public static GUIStyle StyleGreen { get { return Style (new Color (0f, 1f, 0.5f, 0.3f)); } }
        public static GUIStyle StyleOrange { get { return Style (new Color (1f, 0.5f, 0.0f, 0.3f)); } }
        public static GUIStyle Border { get { return Style (new Color (0, 0.5f, 1f, 0.0f)); } }
        public static GUIStyle FlatBox { get { return Style (new Color (0.35f, 0.35f, 0.35f, 0.1f)); } }
